...
//    Team5_Validate_Notempty
    "Please fill in the '%name%'" => "Пожалуйста, заполните '%name%'",

//    Team5_Validate_Name
    "You used not allowed symbols" =>"Вы использовали недопустимые символы",
    "%name%'should contain at least one letter"=>"'%name%' должно содержать хотя бы одну букву",
//    title
    'Use only letters of English and Russian alphabet, digits, spaces, punctuation marks like full points, commas, colons, semicolon, low lines, dashes, apostrophe and symbols like +, @, #. Maximum 50 symbols.'=>'Используйте только буквы английского и русского алфавита, цифры, пробелы, точки, запятые, двоеточия, точки с запятой, нижние подчеркивания, тире, апострофы и символы +, @, #. Максимум 50 символов'
);
